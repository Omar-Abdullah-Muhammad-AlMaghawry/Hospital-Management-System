...
import '../bloodbank.dart'; /////bloodbank page
...
class PatientHomeScreen extends StatelessWidget {
 ...
 Future getnumofbloodbags()async{
  ...
  // print(y);
   ...
   xaplus = v;
////////////ANEG
     await Firestore.instance.collection('bloodBank').doc('Aneg').get().then((value) {
   ...
   ////////Bplus
        await Firestore.instance.collection('bloodBank').doc('Bplus').get().then((value) {
   ...
   xbplus = v;
///Bneg
    await Firestore.instance.collection('bloodBank').doc('Bneg').get().then((value) {
   ...
   xbneg = v;
   /////////ABplus
    await Firestore.instance.collection('bloodBank').doc('ABplus').get().then((value) {
   ...
   xabplus = v;
    /////ABneg
     await Firestore.instance.collection('bloodBank').doc('ABneg').get().then((value) {
   ...
   xabneg = v;
   ///Oplus
    await Firestore.instance.collection('bloodBank').doc('oplus').get().then((value) {
 ...
 await Firestore.instance.collection('bloodBank').doc('oneg').get().then((value) {
         ...
         onPressed: ()async{
           ...
           x =await getnumofbloodbags();
             ...
             Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => Bloodbank (aplus: xaplus,bplus: xbplus,
                                oplus: xoplus,abplus: xabplus,abneg: xabneg,aneg: xaneg,bneg:xbneg,oneg:xoneg,
